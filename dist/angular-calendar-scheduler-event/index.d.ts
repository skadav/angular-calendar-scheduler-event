...
declare function provideCalendar(
 ...
 * ```
 */
declare class CalendarMomentDateFormatter
 ...
 */
declare class CalendarNativeDateFormatter
  implements CalendarDateFormatterInterface
{
  protected dateAdapter: DateAdapter;
  /**
 ...
 */
declare class CalendarAngularDateFormatter
  implements CalendarDateFormatterInterface
{
  protected dateAdapter: DateAdapter;
  /**
 ...
 * ```
 */
declare class CalendarMonthViewComponent
...
declare function getWeekViewPeriod(
...
declare function isWithinThreshold({ x, y }: { x: number; y: number }): boolean;
...
interface WeekViewAllDayEventResize$2 {
  originalOffset: number;
  originalSpan: number;
  edge: string;
}
interface CalendarWeekViewBeforeRenderEvent$2 extends WeekView {
  header: WeekDay[];
}
/**
 ...
 * ```
 */
declare class CalendarWeekViewComponent
  implements OnChanges, OnInit, OnDestroy, AfterViewInit
{
   ...
   */
  beforeViewRender: EventEmitter<CalendarWeekViewBeforeRenderEvent$2>;
  /**
   ...
   * @hidden
   */
  allDayEventResizes: Map<WeekViewAllDayEvent, WeekViewAllDayEventResize$2>;
  /**
   * @hidden
   */
...
declare class CalendarWeekViewEventComponent {
  ...
  eventTitleTemplate: TemplateRef<any>;
  eventActionsTemplate: TemplateRef<any>;
  eventTimeTitleTemplate: TemplateRef<any>;
  tooltipTemplate: TemplateRef<any>;
...
interface OtoCalendarEvent extends CalendarEvent {
  column?: number;
  data?: {
    id: string;
  };
}
interface OperationDealerHour {
  isOpen: boolean;
  hourSegments: number;
  startHour: number;
  startMinute: number;
...
interface WeekViewAllDayEventResize$1 {
  originalOffset: number;
  originalSpan: number;
  edge: string;
}
interface CalendarWeekViewBeforeRenderEvent$1 extends WeekView {
  header: WeekDay[];
}
declare class OtoCalendarWeekViewComponent
  implements OnChanges, OnInit, OnDestroy, AfterViewInit
{
  columns: number;
  ...
  eventTimesChanged: EventEmitter<CalendarEventTimesChangedEvent<any>>;
  beforeViewRender: EventEmitter<CalendarWeekViewBeforeRenderEvent$1>;
  hourSegmentClicked: EventEmitter<{
    date: Date;
    sourceEvent: MouseEvent;
  }>;
  ...
  view: WeekView;
  refreshSubscription: Subscription;
  allDayEventResizes: Map<WeekViewAllDayEvent, WeekViewAllDayEventResize$1>;
  timeEventResizes: Map<CalendarEvent, ResizeEvent>;
  eventDragEnterByType: {
    allDay: number;
    time: number;
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<OtoCalendarWeekViewComponent, never>;
  static ɵcmp: i0.ɵɵComponentDeclaration<
    OtoCalendarWeekViewComponent,
    'mwl-oto-calendar-week-view',
    never,
    {
      columns: { alias: 'columns'; required: false };
      weekOperationHour: { alias: 'weekOperationHour'; required: false };
      viewDate: { alias: 'viewDate'; required: false };
      events: { alias: 'events'; required: false };
      excludeDays: { alias: 'excludeDays'; required: false };
      refresh: { alias: 'refresh'; required: false };
...
declare class OtoCalendarDayViewComponent
  implements OnChanges, OnInit, OnDestroy, AfterViewInit
{
  columns: Array<any>;
  viewDate: Date;
  operationHour: OperationDealerHour;
  ...
  static ɵfac: i0.ɵɵFactoryDeclaration<OtoCalendarDayViewComponent, never>;
  static ɵcmp: i0.ɵɵComponentDeclaration<
    OtoCalendarDayViewComponent,
    'mwl-oto-calendar-day-view',
    never,
    {
      columns: { alias: 'columns'; required: false };
      viewDate: { alias: 'viewDate'; required: false };
      operationHour: { alias: 'operationHour'; required: false };
      events: { alias: 'events'; required: false };
      excludeDays: { alias: 'excludeDays'; required: false };
      refresh: { alias: 'refresh'; required: false };
      locale: { alias: 'locale'; required: false };
...
declare class CalendarDayModule {
  ...
  static ɵmod: i0.ɵɵNgModuleDeclaration<
    CalendarDayModule,
    never,
    [typeof CalendarDayViewComponent, typeof OtoCalendarDayViewComponent],
    [typeof CalendarDayViewComponent, typeof OtoCalendarDayViewComponent]
  >;
...
export type {
  ...
  CalendarWeekViewBeforeRenderEvent$2 as CalendarWeekViewBeforeRenderEvent,
  DateFormatterParams,
};
