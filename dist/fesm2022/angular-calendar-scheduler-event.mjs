...
import {
  validateEvents as validateEvents$1,
  getMonthView,
  getWeekViewHeader,
  getWeekView,
} from 'calendar-utils';
...
import { DateAdapter as DateAdapter$1 } from 'projects/angular-calendar/src/date-adapters/date-adapter';
...
class CalendarEventActionsComponent {
  ...
  `,
      ...
      dependencies: [
        ...
        { kind: 'pipe', type: CalendarA11yPipe, name: 'calendarA11y' },
      ],
    });
  }
}
...
class CalendarTooltipDirective {
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      host: {
        listeners: { mouseenter: 'onMouseOver()', mouseleave: 'onMouseOut()' },
      },
      usesOnChanges: true,
      ngImport: i0,
    });
...
class CalendarPreviousViewDirective {
  ...
  static {
    this.ɵdir = i0.ɵɵngDeclareDirective({
      ...
      outputs: { viewDateChange: 'viewDateChange' },
      host: { listeners: { click: 'onClick()' } },
      ngImport: i0,
    });
  }
}
...
class CalendarAngularDateFormatter {
  ...
  weekViewTitle({ date, locale, weekStartsOn, excludeDays, daysInWeek }) {
    ...
    const format = (dateToFormat, showYear) =>
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      version: '20.2.1',
      ngImport: i0,
      type: CalendarAngularDateFormatter,
      deps: [],
      target: i0.ɵɵFactoryTarget.Injectable,
    });
  }
...
class CalendarMomentDateFormatter {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      version: '20.2.1',
      ngImport: i0,
      type: CalendarMomentDateFormatter,
      deps: [],
      target: i0.ɵɵFactoryTarget.Injectable,
    });
  }
...
class CalendarNativeDateFormatter {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      version: '20.2.1',
      ngImport: i0,
      type: CalendarNativeDateFormatter,
      deps: [],
      target: i0.ɵɵFactoryTarget.Injectable,
    });
  }
...
class CalendarMonthViewHeaderComponent {
  ...
  `,
      ...
      dependencies: [
        ...
        { kind: 'pipe', type: CalendarDatePipe, name: 'calendarDate' },
      ],
    });
  }
}
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      host: {
        ...
        classAttribute: 'cal-cell cal-day-cell',
      },
      ngImport: i0,
      template: `
    <ng-template
  ...
  `,
      ...
      dependencies: [
        ...
        },
        {
          ...
          type: CalendarEventTitleComponent,
          selector: 'mwl-calendar-event-title',
          inputs: ['event', 'customTemplate', 'view'],
        },
        {
          kind: 'directive',
          type: ClickDirective,
...
class CalendarMonthViewComponent {
  ...
  eventDropped(droppedOn, event, draggedFrom) {
    if (droppedOn !== draggedFrom) {
      ...
      const newStart = this.dateAdapter.setDate(
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      ngImport: i0,
      template: `
    <div class="cal-month-view" role="grid" style="margin-top: 20px;">
      ...
      dependencies: [
        {
          ...
          type: CalendarMonthViewHeaderComponent,
          selector: 'mwl-calendar-month-view-header',
          inputs: ['days', 'locale', 'customTemplate'],
          outputs: ['columnHeaderClicked'],
        },
        {
          kind: 'component',
          type: CalendarMonthCellComponent,
          ...
          outputs: ['highlightDay', 'unhighlightDay', 'eventClicked'],
        },
        {
          kind: 'directive',
          type: DroppableDirective,
          selector: '[mwlDroppable]',
          inputs: ['dragOverClass', 'dragActiveClass', 'validateDrop'],
          outputs: ['dragEnter', 'dragLeave', 'dragOver', 'drop'],
        },
        {
          kind: 'directive',
          type: NgClass,
        ...
        },
        {
          ...
          outputs: ['eventClicked'],
        },
        { kind: 'pipe', type: SlicePipe, name: 'slice' },
        { kind: 'pipe', type: CalendarA11yPipe, name: 'calendarA11y' },
      ],
    });
  }
...
class OtoCalendarEventTimeTitleComponent {
  ngOnInit() {
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      version: '20.2.1',
      ngImport: i0,
      type: OtoCalendarEventTimeTitleComponent,
      deps: [],
      target: i0.ɵɵFactoryTarget.Component,
    });
  }
  ...
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      inputs: {
        ...
        eventTitleTemplate: 'eventTitleTemplate',
        eventActionsTemplate: 'eventActionsTemplate',
        eventTimeTitleTemplate: 'eventTimeTitleTemplate',
        tooltipTemplate: 'tooltipTemplate',
        column: 'column',
        daysInWeek: 'daysInWeek',
      },
...
class CalendarWeekViewCurrentTimeMarkerComponent {
  ...
  `,
      ...
      dependencies: [
        ...
        { kind: 'pipe', type: AsyncPipe, name: 'async' },
      ],
    });
  }
}
      ...
      dependencies: [
        {
          ...
          selector: 'mwl-calendar-week-view-header',
          inputs: ['days', 'locale', 'customTemplate'],
          outputs: ['dayHeaderClicked', 'eventDropped', 'dragEnter'],
        },
        {
          kind: 'directive',
          type: DroppableDirective,
        ...
        },
        {
          ...
          outputs: ['resizeStart', 'resizing', 'resizeEnd'],
        ...
        },
        {
          ...
          inputs: ['resizeEdges', 'resizableContainer'],
        },
        {
          kind: 'component',
          type: CalendarWeekViewEventComponent,
...
class OtoCalendarViewBreakTimeMarkerComponent {
  constructor() {
    this.columnDate$ = new BehaviorSubject(undefined);
    this.dateAdapter = inject(DateAdapter$1);
    this.zone = inject(NgZone);
    this.marker$ = this.zone.onStable.pipe(
      switchMap(() => interval(60 * 1000)),
      startWith(0),
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      version: '20.2.1',
      ngImport: i0,
      type: OtoCalendarViewBreakTimeMarkerComponent,
      deps: [],
      target: i0.ɵɵFactoryTarget.Component,
    });
  }
  ...
  `,
      isInline: true,
      styles: ['.cal-break-time-marker{font-size:14px;white-space:nowrap}\n'],
      dependencies: [
        {
          kind: 'directive',
          type: NgTemplateOutlet,
        ...
        { kind: 'pipe', type: AsyncPipe, name: 'async' },
        { kind: 'pipe', type: DecimalPipe, name: 'number' },
      ],
    });
  }
}
i0.ɵɵngDeclareClassMetadata({
  ...
  `,
          ...
          styles: [
            '.cal-break-time-marker{font-size:14px;white-space:nowrap}\n',
          ],
        },
      ],
    },
...
class OtoCalendarWeekViewComponent {
  constructor() {
    this.events = [];
    this.excludeDays = [];
    this.locale = inject(LOCALE_ID);
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      version: '20.2.1',
      ngImport: i0,
      type: OtoCalendarWeekViewComponent,
      deps: [],
      target: i0.ɵɵFactoryTarget.Component,
    });
  }
  static {
    this.ɵcmp = i0.ɵɵngDeclareComponent({
      ...
      inputs: {
        columns: 'columns',
        weekOperationHour: 'weekOperationHour',
        viewDate: 'viewDate',
        events: 'events',
        excludeDays: 'excludeDays',
        refresh: 'refresh',
...
class OtoCalendarWeekViewHeaderComponent {
  constructor() {
    this.dayHeaderClicked = new EventEmitter();
    this.eventDropped = new EventEmitter();
    this.dragEnter = new EventEmitter();
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      version: '20.2.1',
      ngImport: i0,
      type: OtoCalendarWeekViewHeaderComponent,
      deps: [],
      target: i0.ɵɵFactoryTarget.Component,
    });
  }
...
class OtoCalendarDayViewComponent {
  constructor() {
    this.columns = [];
    this.events = [];
    this.excludeDays = [];
  ...
  dragEnded(weekEvent, dragEndEvent, dayWidth, useY = false) {
    ...
    if (
      ...
      this.lastDraggedEvent = weekEvent.event;
      const newEvent = weekEvent.event;
  ...
  static {
    this.ɵfac = i0.ɵɵngDeclareFactory({
      ...
      version: '20.2.1',
      ngImport: i0,
      type: OtoCalendarDayViewComponent,
      deps: [],
      target: i0.ɵɵFactoryTarget.Component,
    });
  }
  ...
  `,
      ...
      dependencies: [
        ...
        },
        {
          ...
          type: OtoCalendarWeekViewHeaderComponent,
          selector: 'mwl-oto-calendar-day-view-header',
          inputs: ['columns', 'locale', 'customTemplate'],
          outputs: ['dayHeaderClicked', 'eventDropped', 'dragEnter'],
        },
        {
          kind: 'directive',
...
//# sourceMappingURL=angular-calendar-scheduler-event.mjs.map
